            ...
            <div class="navbar-start">
              <div class="navbar-item has-dropdown is-hoverable">
                ...
                <div class="navbar-dropdown is-boxed">
                  <a class="navbar-link" v-for="(cat, index) in categories" :index="'1-' + index" :key="'1-' + index" :href="baseUrl + keyword + '/' + cat.slug + '/'">
                    {{ cat.title }} [{{ cat.post_count }}]
                  </a>
                  <hr class="navbar-divider">
                  <strong class="navbar-item has-text-info">
                    <a :href="baseUrl + catKey + '/1/'" class="navbar-link">
                      All categories
                    </a>
                  </strong>
                </div>
